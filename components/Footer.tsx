        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-white/50 text-sm leading-relaxed max-w-sm">
              Yayasan pemerhati disabilitas yang menciptakan ruang aman dan inklusif 
              bagi penyandang disabilitas untuk berkarya, belajar, dan tumbuh bersama.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary/30 transition-colors"
