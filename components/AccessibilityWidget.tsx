...
const STORAGE_KEY = 'omahgembira-a11y'
          ...
          <div>
            ...
            {showAdvanced && (
              <div className="a11y-submenu">
                ...
                >
                  <span className="a11y-feature-icon" style={{ width: 28, height: 28, borderRadius: 8, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'var(--muted)', marginRight: 8 }}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="w-4 h-4">
                      <line x1="2" y1="12" x2="22" y2="12" />
